...
import com.jll.sunshine.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitString = sharedPrefs
                .getString(mContext.getString(R.string.pref_unit_key), mContext.getString(R.string.pref_unit_default));
        Unit unit = Unit.valueOf(unitString);

        high = unit.convertMetricUnit(high);
        low = unit.convertMetricUnit(low);
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        String[] selectionArgs = new String[] { locationSetting, cityName, String.valueOf(lat), String.valueOf(lon) };
